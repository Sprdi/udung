...
func main() {
	...
	r.POST("/sag", authMiddleware, controllers.CreateSag)
	r.GET("/sag/:id", authMiddleware, controllers.SagShow)
	r.PUT("/sag/:id", authMiddleware, controllers.PostsUpdate)
	r.DELETE("/sag/:id", authMiddleware, controllers.PostsDelete)
	r.GET("/exportSag", authMiddleware, controllers.CreateExcelSag)
	r.GET("/updateSag", authMiddleware, controllers.UpdateSheetSAG)
	r.POST("/uploadSag", authMiddleware, controllers.ImportExcelSag)
